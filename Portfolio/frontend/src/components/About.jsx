  ...
  return (
    <>
      <motion.section
        ...
        className="flex flex-col lg:flex-row justify-between items-stretch px-4 sm:px-6 md:px-8 lg:ml-65 lg:mr-36 lg:p-5 gap-8 lg:gap-12 max-w-6xl mx-auto"
      >
        <motion.div
          variants={fadeUp}
          className="w-full max-w-md lg:max-w-[370px] flex flex-col justify-between space-y-4 shrink-0"
        >
          <div className="w-full">
            <ProfileCard
              ...
              linkedinUrl="https://www.linkedin.com/in/gagan-singh-7b35b43aa/"
        ...
        <motion.div
          variants={container}
          className="flex flex-col justify-between space-y-6 w-full lg:max-w-xl"
        >
          <motion.h2
            variants={fadeUp}
            initial="hidden"
          ...
          <motion.div variants={fadeUp} className="relative pl-6">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              Computer Science Engineering student with a solid foundation in
              programming, full-stack development, and Artificial Intelligence.
              Proficient in C++, Python, JavaScript, and modern web frameworks,
              passionate about creating{" "}
              <span className="text-[#27CBCB]">
                scalable, intuitive, and reliable
              </span>{" "}
              software solutions with clean system architecture.
            </p>
          </motion.div>
          <motion.div
            variants={fadeUp}
