...
import PurpleLineFlow from "../components/PurpleLineFlow";
import PurpleBallMagnifier from "../components/PurpleBallMagnifier";
...
const Portfolio = () => {
  return (
    <div className="relative w-full min-h-screen text-gray-300 overflow-x-hidden">
      ...
      <section id="certificates" className="scroll-mt-10">
        <div className="flex flex-row items-center px-4 sm:px-6 lg:ml-50 mt-12 sm:mt-16 lg:mt-20 p-3 sm:p-5 space-x-3">
          <p className="cursor-pointer text-[#27CBCB] text-sm sm:text-base">/certificates</p>
          <div className="bg-gray-700 h-0.5 w-full lg:mr-30 rounded-lg" />
        </div>
        <Certificates />
      </section>
